#ref from https://github.com/stefanknegt/Probabilistic-Unet-Pytorch/blob/master/probabilistic_unet.py
...
train_set = CarDataset(directory=train_folder,transform = None,changelabel=True)

train_loader = DataLoader(dataset=train_set, batch_size=batchsize, shuffle=True)

probUnet = ProbabilisticUnet(input_channels = 3, num_classes = 9)
